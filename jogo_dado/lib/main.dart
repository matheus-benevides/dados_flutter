// Importa a biblioteca para trabalhar com números aleátorios (para o dado)
import 'dart:math';
// Improtatnto o pacote principal do Flutter (widgets, design...etc)
...
class _EstadoTelaConfiguracaoJogadores extends State<TelaConfiguracaoJogadores>{
  // Chave Global para identificar e validade o Widget
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 16,), // Espaçamento de altura entre os inputs
              ...
              const Spacer(), // Ocupar o espaço vertical disponível, empurando o botão p/ baixo
...
class _EstadoTelaJogoDeDados extends State<TelaJogodeDados>{
  ...
  void _lancarDados(){ // Quando eu uso o sublinhado _ significa que ela é privada, só pode ser usada
  // dentro dessa classe
  ...
  Widget _constuirColunaJogador(String nome, List<int> lancamentos){
    return Expanded( // Pega todo o espaço disponívle dentro de uma row ou column
      child: Column(
        children: [
